...
## 💾 Phase 3: The "Second Brain" (Хранилище и Память) — [ОБНОВЛЕНО v2.4]
...
- [ ] **Multi-Agent Coordination:** Реализовать межагентную коммуникацию через расширенный EventBus.
- [ ] **Memory Migration:** Планируется миграция на более эффективные embedding-модели (например, NV-Embed).
- [ ] **Offline-first Cache:** Добавить кэшрование запросов RAG для работы без доступа к Ollama.