...
# Импортируем конфиг и инфраструктуру
...
# ИСПРАВЛЕНО: Глобальный импорт orchestrator удален отсюда для предотвращения циклических импортов верхнего уровня
...
async def main():
    ...
    # КРИТИЧЕСКИЙ ФИКС: Ленивый импорт и запуск оркестратора строго в рантайме,
    # когда вся инфраструктура, шина событий и конфигурации уже гарантированно сидят в памяти.
